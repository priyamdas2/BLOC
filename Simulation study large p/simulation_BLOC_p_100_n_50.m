...
for k=reps_to_do
    ...
    comp_time_final_overall = toc(tStart);

    fprintf('=> Overall time taken: %.2f secs.\n', comp_time_final_overall);
    ...
    output = [ErrFro, ErrSpe, err_abs, TPR, FPR, MCC, PD, comp_time_final_overall];
