...
filename = sprintf(['outputs/Summary_WeiZhaoMCP_COV_MEAN_method_%d_p_%d_n_%d.csv'], ...
                    method_num, p, n);

dlmwrite(filename, round(summary_mean, 3), 'precision', '%.3f');


filename = sprintf(['outputs/Summary_WeiZhaoMCP_COV_SE_method_%d_p_%d_n_%d.csv'], ...
                    method_num, p, n);
