...
summary_mean = [mean_vals_1; mean_vals_2; mean_vals_3; mean_vals_4; mean_vals_5;
    mean_vals_6; mean_vals_7; mean_vals_8; mean_vals_9];

summary_stderr = [se_vals_1; se_vals_2; se_vals_3; se_vals_4; se_vals_5;
    se_vals_6; se_vals_7; se_vals_8; se_vals_9];

filename = sprintf(['outputs/Summary_other_methods_MEAN_method_%d_p_%d_n_%d.csv'], ...
                    method_num, p, n);
dlmwrite(filename, round(summary_mean, 3), 'precision', '%.3f');


filename = sprintf(['outputs/Summary_other_methods_SE_method_%d_p_%d_n_%d.csv'], ...
                    method_num, p, n);
