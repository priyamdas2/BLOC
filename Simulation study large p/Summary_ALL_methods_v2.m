...
for k = 1:Num_exps
    ...
    filename = sprintf( ...
        ['output_FroSpecAbsTprFprMccPDTime_' ...
         'method_%d_p_%d_n_%d_BLOC_penalty_%d_REP_%d.csv'], ...
         method_num, p, n, penalty, k);

    temp = readmatrix(filename);

    output_BLOC_MCP = [output_BLOC_MCP; temp];

end

[mean_vals_01, se_vals_01] = summary_stats(output_BLOC_MCP);
...
for k = 1:Num_exps
    ...
    output_BLOC_SCAD = [output_BLOC_SCAD; temp];

end

[mean_vals_02, se_vals_02] = summary_stats(output_BLOC_SCAD);


filename = sprintf(['output_FroSpecAbsTprFprMccPDTime_method_%d_p_%d_n_%d_' ...
                    'NumExp_%d_WeiZhaoMCP.csv'], ...
                    method_num, p, n, Num_exps);
output_WeiZhaoMCP = csvread(filename);
[mean_vals_021, se_vals_021] = summary_stats(output_WeiZhaoMCP);

filename = sprintf(['output_FroSpecAbsTprFprMccPDTime_method_%d_p_%d_n_%d_' ...
                    'NumExp_%d_WeiZhaoMCP_Cov.csv'], ...
                    method_num, p, n, Num_exps);
output_WeiZhaoMCP_Cov = csvread(filename);
[mean_vals_022, se_vals_022] = summary_stats(output_WeiZhaoMCP_Cov);
...
summary_mean = [mean_vals_01; mean_vals_02; mean_vals_021; mean_vals_022; mean_vals_1; mean_vals_2; mean_vals_3; mean_vals_4; mean_vals_5;
    mean_vals_6; mean_vals_7; mean_vals_8; mean_vals_9];

summary_stderr = [se_vals_01; se_vals_02; se_vals_021; se_vals_022; se_vals_1; se_vals_2; se_vals_3; se_vals_4; se_vals_5;
...
out = format_mean_se_csv(method_num, p, n, fullfile(pwd,'outputs'));