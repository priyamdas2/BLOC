...
%       SCAD_BCD, IRW_ADMM, Trad_IRW, soft_thres, hard_thres, SCAD_thres
    ...
    % ----- Filenames
    meanFile = fullfile(baseDir, sprintf('Summary_ALL_methods_MEAN_method_%d_p_%d_n_%d.csv', method, p, n));
    seFile   = fullfile(baseDir, sprintf('Summary_ALL_methods_SE_method_%d_p_%d_n_%d.csv',   method, p, n));
    outPath  = fullfile(baseDir, sprintf('Summary_ALL_methods_FORMATTED_method_%d_p_%d_n_%d.csv', method, p, n));
