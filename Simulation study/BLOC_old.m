function [C_opt, fval, comp_time] = BLOC_old(objFun, C0, MaxTime, MaxRuns, MaxIter, sInitial, rho, TolFun1, TolFun2, phi, DisplayUpdate, DisplayEvery, PrintStepSize, PrintSolution)
...
if (nargin < 2)
    fprintf('==> Error: Please provide an initial point. If not sure, try out any M x M correlation matrix. You may use the function randCorrMatrix().  \n')
    return;
end

if nargin < 3, MaxTime = 3600; end
if nargin < 4, MaxRuns = 1000; end
if nargin < 5, MaxIter = 10000; end
if nargin < 6, sInitial = 1; end
if nargin < 7, rho = 2; end
if nargin < 8, TolFun1 = 10^(-6); end
if nargin < 9, TolFun2 = 10^(-20); end
if nargin < 10, phi = 10^(-20); end
if nargin < 11, DisplayUpdate = 1; end
if nargin < 12, DisplayEvery = 2; end
if nargin < 13, PrintStepSize = 1; end
if nargin < 14, PrintSolution = 0; end
